    ...
    <>
      ...
      >
        <div className="max-w-lg mx-auto px-4">
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-2xl p-6 sm:p-8 border border-zinc-100 dark:border-zinc-800 shadow-xl shadow-zinc-100/50 dark:shadow-none">
